...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    {   echo "<p class='mt-12 text-center text-3xl font-serif '>".$prosub." </p>";
        ...
        { 
            ...
            echo "<input type='hidden' name='pro_det' value='".$detail."'>";
            echo " <input type='hidden' name='pro_cat' value='". $prosub."'>";
            echo " <input type='hidden' name='price' value='". $price."'>";
            echo " <input type='hidden' name='image' value='images/".$imagepath."'>";
            echo " <button class='bg-yellow-500 text-white px-3 py-1 rounded hover:bg-orange-600'>Add to Cart</button>";
            echo " </form>";
